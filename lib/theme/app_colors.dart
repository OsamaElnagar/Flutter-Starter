...
class AppColors {
  static const bgFullLight = Color.fromARGB(255, 255, 255, 255);
  ...
  static const bgDark = Color(0xFF1A1D1F);
  static const bgSecondaryDark = Color(0xFF2A2D34);
  static const titleDark = Color(0xFFEFEFEF);
  static const textDark = Color(0xFFB3B3B3);
  static const textGreyDark = Color(0xFF6F767E);
  static const iconDark = Color(0xFFEFEFEF);
  static const iconBlackDark = Color(0xFF1A1D1F);
  static const iconGreyDark = Color(0xFF6F767E);
  static const highlightDark = Color(0xFF2A2D34);
